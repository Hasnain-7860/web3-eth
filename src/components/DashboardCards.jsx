...
export default function DashboardCards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 p-5">

      <div className="rounded-xl p-6 pt-10 text-white bg-gradient-to-br from-blue-600 to-cyan-400 ">
        ...
        <div className="rounded-xl p-5 text-white bg-[#0b0f3a] relative ">
          ...
          <p className="text-sm md:text-lg xl:text-[22px]  mb-2">Total Factoids 🕷 Issued</p>
